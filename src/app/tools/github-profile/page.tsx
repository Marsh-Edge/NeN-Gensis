    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-3">
          <h1 className="text-2xl sm:text-3xl font-bold text-white">GitHub Profile</h1>
          <Badge variant="success" className="text-[10px]">Free • No API Key</Badge>
        </div>
        <p className="text-white/50 text-sm sm:text-base">Look up any GitHub user — profile info, stats, and top repositories.</p>
      </div>
      <GitHubProfileWidget />
    </div>
  )
